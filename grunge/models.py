...
class PlayList(UUIDModel):
    name = models.CharField(max_length=100, unique=True, help_text=_("The playlist name"))
    track = models.ManyToManyField(Track, help_text=_("The tracks in the playlist"))
    ...
    def get_absolute_url(self):
        return reverse("admin:grunge_playlists_change", kwargs={"object_id": self.pk})